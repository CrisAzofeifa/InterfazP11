        ...
        ui(new Ui::IDE_CFactorial)
{
    ...
    ////////////////////////////////
    ui->RamLiveView->setRowCount(10);
    ui->RamLiveView->setColumnCount(4);
    ui->RamLiveView->setColumnWidth(4,56);
    ...
    //insert data
    ui->RamLiveView->setItem(0, 1, new QTableWidgetItem("Hello"));

   /* connect( ui->RamLiveView, SIGNAL( cellDoubleClicked (int, int) ),
